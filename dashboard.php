...
<body class="animsition">
 ...
 <?php
//todays visitors
 $query=mysqli_query($con,"select user_id from user");
$candidats=mysqli_num_rows($query);
 ?>                       
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <span>Visiteur d'aujourd'hui</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <span> Visiteurs de  7 derniers jours </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <span>Nombre total de  Visiteurs</span>
                                            </div>
                                        </div>
