...
$reasontomeet=$_POST['reasontomeet'];
 $query=mysqli_query($con,"insert into tblvisitor(FullName,Email,MobileNumber,Address,WhomtoMeet,Deptartment,ReasontoMeet) value('$fullname','$email','$mobnumber','$add','$whomtomeet','$department','$reasontomeet')");
    ...
    if ($query) {
    $msg="le details de visiteur est ajoutée avec succée";
  }
  else
    {
...
<head>
    ...
    <!-- Title Page-->
    <title>Formulaire d'inscription de Visiteurs</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ajouter</strong> Nouveau visiteur
                                    </div>
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Nom et  prénom</label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Télephone</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Addresse</label>
                                                </div>
                                                <div class="col-12 col-md-9">
